...
var deleteBtn = document.querySelectorAll("#deleteCommentBtn");
var addComment = function addComment(text, commentId) {
  ...
  var newDeleteCommentBtn = document.querySelector("#newDeleteCommentBtn");
...
var handleClick = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
    var _event$target$dataset, id, videoid, response;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _event$target$dataset = event.target.dataset, id = _event$target$dataset.id, videoid = _event$target$dataset.videoid;
          _context2.next = 3;
          return fetch("/api/videos/".concat(videoid, "/comments/").concat(id, "/delete"), {
            method: "DELETE",
            headers: {
              "Content-Type": "application/json"
            },
...
if (deleteBtn) deleteBtn.forEach(function (btn) {
