...
var startGithubLogin = exports.startGithubLogin = function startGithubLogin(req, res) {
  ...
  var config = {
    ...
    allow_signup: false,
    scope: "read:user user:email" //공백으로 띄워줘야함
  };
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          config = {
            client_id: process.env.GH_CLIENT,
            client_secret: process.env.GH_SECRETS,
            code: req.query.code
          };
...
var postEdit = exports.postEdit = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _req$session$user, _id, avatarUrl, _req$body3, name, email, username, location, file, findUsername, findEmail, updateUser;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          findUsername = _context4.sent;
          _context4.next = 6;
          return _User["default"].findOne({
            email: email
          });
        case 6:
          findEmail = _context4.sent;
          if (!(findUsername._id != _id || findEmail._id != _id)) {
            _context4.next = 9;
            break;
          }
          return _context4.abrupt("return", res.render("editProfile", {
            pageTitle: "Edit  Profile",
