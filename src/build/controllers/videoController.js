...
var deleteComment = exports.deleteComment = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(req, res) {
    var _req$body3, id, videoid, _id, _yield$Comment$findBy, owner, video;
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          _req$body3 = req.body, id = _req$body3.id, videoid = _req$body3.videoid; // comment id, video id
          _id = req.session.user._id; // user id
          _context10.next = 4;
          return _Comment["default"].findById(id);
        case 4:
          _yield$Comment$findBy = _context10.sent;
          owner = _yield$Comment$findBy.owner;
          _context10.next = 8;
